...
def solve_piece(p, arr):
    ...
    # sanity check to make sure there's no terrible bugs
    if run == 25:
	print("something bad has happened. contact tom o'donnell please with the cubestate you used.")
        quit()
